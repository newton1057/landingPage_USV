...
export function Logo({ className, width = 80, height = 28 }: LogoProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M54.5,33.2c-11.4,0-20.6-9.2-20.6-20.5V12.2h7.4v10.5c0,7.3,5.9,13.2,13.2,13.2s13.2-5.9,13.2-13.2V12.2h7.4v10.5C75.1,24,65.9,33.2,54.5,33.2z"
        fill="currentColor"
      />
      <path
        d="M78.6,33.2c-7.3,0-13.2-5.9-13.2-13.2V1.4h7.4v20.5c0,3.2,2.6,5.8,5.8,5.8s5.8-2.6,5.8-5.8V1.4h7.4V20C91.8,27.3,85.9,33.2,78.6,33.2z"
        fill="currentColor"
      />
      <path
