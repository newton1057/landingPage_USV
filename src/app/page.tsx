...
import { Sparkles, Camera, ArrowRight, Facebook, Instagram, Twitter, MessageCircle } from "lucide-react";
        ...
        <section id="what-is-ima" className="py-20 sm:py-24 bg-secondary/50">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl font-headline flex items-center justify-center gap-2">¿Qué es <ImaLogo className="text-foreground h-auto w-40" />?</h2>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div className="flex flex-col items-center gap-4 md:items-start">
              <ImaLogo className="text-foreground h-auto w-40" />
